;; honey-token.clar
;; SIP-010 Fungible Token: $HONEY
;; 6 decimals, capped at 1_000_000_000 * 10^6

(impl-trait .traits.ft-trait)

(define-constant DECIMALS u6)
(define-constant MAX_SUPPLY u1000000000000000)
(define-constant TOKEN_NAME "Honey")
(define-constant TOKEN_SYMBOL "HONEY")
...
;; Admin: set authority (one-time, then frozen)
